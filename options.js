...
async function loadSettings() {
  try {
    ...
    if (typeof prefs.echoCancellation !== "undefined") {
      document.getElementById("echo-cancellation").checked =
        prefs.echoCancellation;
    }
    if (typeof prefs.noiseSuppression !== "undefined") {
      document.getElementById("noise-suppression").checked =
    ...
    if (typeof prefs.enableKeyboardShortcuts !== "undefined") {
      document.getElementById("enable-keyboard").checked =
        prefs.enableKeyboardShortcuts;
    }
